...
const Signin = () => {
    ...
    return (
        <section>
            <h1 className='text-3xl text-center font-Times_New_Roman font-semibold mt-6'>Sign In</h1>
            ...
            <div className='flex justify-center flex-wrap items-center py-12 px-6 lg:max-w-6xl mx-auto'>
                ...
                <div className='w-full md:w-[67%] lg:w-[40%] lg:ml-12'>
                    <form onSubmit={onSubmit}>
                        ...
                        <button className='w-full bg-blue-600 text-white py-3 px-7 font-medium uppercase rounded shadow-md hover:bg-blue-700 transition duration-150 ease-in-out hover:shadow-xl active:bg-blue-800' type='submit'>Sign in</button>
