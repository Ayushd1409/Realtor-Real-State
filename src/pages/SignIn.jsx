        ...
        <div className='flex justify-center flex-wrap items-center py-12 px-6 lg:max-w-6xl mx-auto'>
          ...
          <div className='w-full md:w-[67%] lg:w-[40%] lg:ml-20'>
            <form>
              ...
              <button className='w-full bg-blue-600 text-white px-7 py-3 text-sm font-medium upercase rounded shadow-md hover:bg-blue-700 transition duration-150 ease-in-out active:bg-blue-800' type='submit'>Sign In</button>
